...
This example demonstrates how to use ManifoldWriter for authenticated operations
like placing bets and managing your account.
...
def main():
    ...
    if not api_key:
        ...
        print("Please set your API key: export MANIFOLD_API_KEY='your_key_here'")
        return
    ...
    try:
        ...
        print(f"Market impact for 10Ṁ YES bet:")
    ...
    print("  writer.place_limit_yes(market_id, 10, 0.7)  # 10Ṁ limit order at 70%")
